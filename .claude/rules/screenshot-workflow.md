---
# No paths — applies to all work in this project
---
...
2. **Screenshot** the rendered page using Puppeteer. If the page has distinct sections, capture those individually too.
...
4. **Fix** every mismatch found. Edit the HTML/CSS code.
